...
<p>You will then be asked to complete a series of questionnaires designed to access the quality of life and well-being of you and your child. Altogether, it should not take you more than 20-30 minutes. These questionnaires will focus on:</p>
<ul>
...
<p>To further assist our research, we would kindly invite you and your child to become members of a data repository site called ‘Open Humans’. Open Humans allows people to anonymously donate their health related data (including device data i.e. from their glucose monitoring, or Nightscout, etc.) for research purposes. Once you sign up to Open Humans, we invite you to join <b>our</b> project on the Open Humans platform called the ‘Open Project’. This should take you no longer than 2-3 minutes.</p>
<p>Choosing to sign up to Open Humans and joining the OPEN project on Open Humans is <b>optional</b> and <b>you decide</b> what data you would like to share with us (if at all), and whether you and your child would like to participate in any further follow on studies. Bear in mind that your participation in the OPEN project and future studies will greatly assist us to enhance the existing scientific evidence on DIYAPS.</p>
