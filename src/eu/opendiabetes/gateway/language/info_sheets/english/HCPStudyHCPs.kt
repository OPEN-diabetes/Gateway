...
<ol>
    <li>to assess the level of agreement between the people with diabetes' self-reported medical outcomes and their outcomes from medical charts reported by their healthcare professional</li>
</ol>
...
<p>Our goal here is to check the accuracy of self-reported clinical outcomes against outcomes from medical records. We would like to be as objective as possible in our research; your help will ensure the accuracy of our self-reported data.</p>
<p>In  our  main  survey  data  collection  targeted  at  people  with  diabetes  (see  more  details <a href="https://survey.open-diabetes.eu">here</a>), we ask the participants to report their clinical outcomes, such as recent hemoglobin A1C levels, height, weight, comorbidities, etc. All clinical outcome data reported by the participants are self-reported, and therefore we want to add a follow-up study that involves you, the diabetes specialist healthcare professional (HCP)!</p>
...
<p>Now that you finally know what we are asking, please decide if you are willing to help us, your patient and the wider diabetes community. If so, please read this information sheet further, and then provide the consent to take part in this study. Once you consent, you will be able to access a separate part of the OPEN survey which is only visible to you and provide your patient's health-related information into a blank survey form. None of your answers will be visible to your patient.</p>
<h1>How will the data be used?</h1> 
<p>The pseudonymized responses to the survey will be compared with your patient's responses and analyzed by a team of researchers. The final results will be disseminated in scientific presentations or articles. Once the OPEN project is completed, the anonymized data will be available to researchers upon request. To protect your privacy, any information that might lead to your or your patient's identity will be removed from the data set before being accessed by any researchers.</p>
