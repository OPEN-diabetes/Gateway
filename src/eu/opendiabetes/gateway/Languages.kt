...
object English : Language() {
    ...
    override val answerAFewQuestions = "Please answer a few questions if you like. This will take no longer than 20 to 30 minutes."
    override val goToSurvey = "Go to survey"
    override val signOut = "Sign out"
    override val linkToOpenHumans = "Additional: Link to Open Humans (optional)"
    override val linkToOpenHumansTextSetup = "Please consider helping us to further enhance the evidence base by joining Open Humans! This should take no longer than 20-30 minutes. Open Humans is a nonprofit citizen science platform where people can anonymously donate and consent to share their data. OPEN has built their own project on this platform. If you provide your link to Open Humans, this will help us to contact you anonymously if needed, and enhance our knowledge about DIYAPS by linking your survey results with other diabetes data. The following step-by-step guide will help you create an Open Humans account, upload your data and make it available to us."
