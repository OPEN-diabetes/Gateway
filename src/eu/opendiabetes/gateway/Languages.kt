...
object English : Language() {
    ...
    override val linkToOpenHumansTextSetup = "Open Humans is a nonprofit citizen science platform where people can anonymously donate and consent to share their data. OPEN has been allowed to work with this platform. If you provide your link to Open Humans, this will help us to contact you anonymously if needed, and enhance our knowledge about DIYAPS by linking your survey results with other diabetes data. The following step-by-step guide will help you create an Open Humans account, upload your data and make it available to us."
