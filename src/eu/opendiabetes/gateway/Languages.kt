...
object English : Language() {
    ...
    override val nightscoutDataTransferDescription = "If you are alreading uploading your data to Nightscout, use this simple tool to copy your data over to Open Humans."
    ...
    override val dataSelfieDescription = "None of the above work out for you? The Data Selfie tool allows you to upload any data you want, e.g. an export from Dexcom Clarity or another software of your choice. Our researchers are also happy to receive pictures of your cat."
    override val noData = "I do not want to upload my data"
    override val noDataDescription = "This is also fine. Open Humans still allows us to connect you anonymously. You can come back to this site at any time if you have changed your mind."
    ...
    override val pleaseReuseAccount = "Please reuse the account the account that you have already used in the past to link to your Participant ID."
    ...
    override fun missingDataSources(removeLink: String, tryAgain: String) =
        """If the list of data sources appears to be incomplete, please <a target="_blank" href="$removeLink">click here</a> to remove the link and <a href="$tryAgain">try again</a>. If have you have recently setup a new data source, it might take a while to be detected."""

    override fun ifYouDidAddAnyDataSources(removeLink: String, tryAgain: String) =
        """If you did add any data sources, please <a target="_blank" href="$removeLink">click here</a> to remove the link and <a href="$tryAgain">try again</a>. If have you have recently setup a new data source, it might take a while to be detected."""
...
object German : Language() {
    ...
    override val linkToOpenHumansTextSetup = "Dies hilft uns, dich anonym kontaktieren zu können und optional weitere Forschungsergebnisse zu können, indem wir deine Umfrageergebnisse weiteren Diabetes-Daten verbinden. Die folgende Schritt-für-Schritt-Anleitung hilft dir dabei, einen Open Humans Account zu erstellen, deine Daten hochzuladen und sie uns zur Verfügung zu stellen."
    ...
    override val nightscoutDataTransferDescription = "Falls du deine Daten bereits zu Nightscout hochlädst, kannst du dieses simple Werkzeug dazu nutzen, deine Daten zu Open Humans herüber zu kopieren."
    ...
    override val dataSelfieDescription = "Nichts der obigen passt so richtig? Mit dem Data Selfie Werkzeug kannst du alle Daten hochladen, die du möchtest, z.B. ein Export von Dexcom Clarity oder einer anderen Software deiner Wahl. Unsere Forscher freuen sich auch über Bilder von deiner Katze."
    override val noData = "Ich möchte meine Daten nicht hochladen"
    override val noDataDescription = "Das ist auch in Ordnung. Open Humans erlaubt uns immer noch, dich anonym zu kontaktieren. Du kannst jederzeit hierher zurückkehren, falls du deine Meinung geändert hast."
    override val linkToOpenHumansDescription = "Ein letzter Schritt, um die Verbindung zu deinem Open Humans Account herzustellen. Du musst diesen Schritt wiederholen, solltest du in der Zukunft eine weitere Datenquelle hinzufügen."
    ...
    override val pleaseReuseAccount = "Bitte benutze den Account, den du bereits in der Vergangenheit mit deiner Teilnehmer-ID verknüft hast."
